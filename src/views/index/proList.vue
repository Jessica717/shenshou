<template>
  <div>
    ...
    <div class='type_bg'>
      ...
      <!--   -->
      <div class='red_list' v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="30">
      ...
      <div :class="{'animated slideInRight fifter_more':fifter,'animated slideOutRight fifter_more':!fifter}" style="height: 100%"
        v-if='fifter'>
